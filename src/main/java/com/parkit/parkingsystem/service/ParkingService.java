...
/**
 * This method is called when a client enters the parking.
 */
	...
	private String getVehicleRegNumber() throws Exception {
		System.out.println(
				"Please type the vehicle registration "
				+ "number and press enter key");
		return inputReaderUtil.readVehicleRegistrationNumber();
	}
/**
 * This method verify if there is a spot available
 * and return it.
 * @return ParkingSpot
 */
	...
	parkingSpot = new ParkingSpot(parkingNumber, parkingType, true);
			...
			LOGGER.error(
			"Error parsing user input for type of vehicle", ie);
		} catch (Exception e) {
			LOGGER.error(
			"Error fetching next available parking slot", e);
		}
		return parkingSpot;
	}
...
/**
 * This method is called when a client wants to exit the parking.
 */
		...
		try {
			...
			if (ticketDAO.updateTicket(ticket)) {
			 ...
			 + ticket.getVehicleRegNumber() + " is:" + outTime);
				...
				System.out.println(
				"Unable to update ticket information. "
				+ "Error occurred");
			}
		} catch (Exception e) {
